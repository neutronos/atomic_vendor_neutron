...
PIXYS_BUILD_DATETIME := $(shell date +%s)
PIXYS_BUILD_DATE := $(shell date -d @$(PIXYS_BUILD_DATETIME) +"%Y%m%d-%H%M%S")
PIXYS_VERSION := NeutronOS-$(PIXYS_MOD_VERSION)-$(PIXYS_BUILD)-$(PIXYS_BUILD_TYPE)-$(PIXYS_BUILD_DATE)
PIXYS_FINGERPRINT := NeutronOS/$(PIXYS_MOD_VERSION)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(PIXYS_BUILD_DATE)
PIXYS_DISPLAY_VERSION := NeutronOS-$(PIXYS_MOD_VERSION)-$(PIXYS_BUILD_TYPE)-$(PIXYS_BUILD_DATE)
